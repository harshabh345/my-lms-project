...
export const banUser = createAsyncThunk(
  ...
  async (userId, { rejectWithValue }) => {
    try {
      await axios.put(`${import.meta.env.VITE_API_URL}/admin/ban/${userId}`, {}, { withCredentials: true });
...
export const unbanUser = createAsyncThunk(
  ...
  async (userId, { rejectWithValue }) => {
    try {
      await axios.put(`${import.meta.env.VITE_API_URL}/admin/unban/${userId}`, {}, { withCredentials: true }); // ✅ No body needed
